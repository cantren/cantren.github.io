...
/* //unpool NOTE: This entire block of code is identical to "PoolLayer" except every instance of "Pool" has been replaced with "UnPool"
(function(global) {
  "use strict";
  var Vol = global.Vol; // convenience
  
  var UnPoolLayer = function(opt) {//unpool
  ...
  UnPoolLayer.prototype = {
    ...
    backward: function() { 
      // unpooling layers have (->Still true?)no parameters, so simply compute 
      // gradient wrt data here
      var V = this.in_act;
      V.dw = global.zeros(V.w.length); // zero out gradient wrt data
      var A = this.out_act; // computed in forward pass 
  ...
  Net.prototype = {
    ...
    makeLayers: function(defs) {
      ...
      for(var i=0;i<defs.length;i++) {
        ...
        switch(def.type) {
          ...
          case 'unpool': this.layers.push(new global.UnPoolLayer(def)); break;//unpooling
    ...
    fromJSON: function(json) {
      ...
      for(var i=0;i<json.layers.length;i++) {
        ...
        if(t==='unpool') { L = new global.UnPoolLayer(); }//unpooling
